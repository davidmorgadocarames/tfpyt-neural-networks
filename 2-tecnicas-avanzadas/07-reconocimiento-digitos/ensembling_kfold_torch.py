"""
Ensembling + validacion cruzada k-fold combinados (PyTorch) sobre digitos MNIST -- version
PyTorch de ensembling_kfold_tf.py (misma muestra reducida, 600/digito).
...
from ensembling_kfold_tf import K_FOLDS, SEED_KFOLD, SEED_MODELO, SEED_SPLIT_FINAL, muestrear_mnist
...
def main(quiet=False) -> dict:
    ...
    plt.title(f"Ensembling + k-fold (k={K_FOLDS}) -- MNIST (PyTorch)", fontweight="bold")
