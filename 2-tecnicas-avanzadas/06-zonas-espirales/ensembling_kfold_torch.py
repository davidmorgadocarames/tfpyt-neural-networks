"""
Ensembling + validacion cruzada k-fold combinados (PyTorch) sobre zonas de espirales --
version PyTorch de ensembling_kfold_tf.py.
...
def main(quiet=False) -> dict:
    ...
    plt.title(f"Ensembling + k-fold (k={K_FOLDS}) -- zonas de espirales (PyTorch)", fontweight="bold")
