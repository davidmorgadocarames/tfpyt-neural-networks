"""
Baseline (PyTorch) del problema de zonas de espirales -- version PyTorch de baseline_tf.py,
...
from baseline_tf import K_CLASES, generar_datos, split_estratificado
